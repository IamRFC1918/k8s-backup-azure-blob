...
sh """ 
docker build --no-cache --tag k8s-backup-azure-blob:2.2 . 
 """		// Shell build step
sh """ 
docker tag k8s-backup-azure-blob:2.2 hub.frank-loeppert.com/k8s-backup-azure-blob:2.2 
 """		// Shell build step
...
sh """ 
docker push hub.frank-loeppert.com/k8s-backup-azure-blob:2.2 
 """		// Shell build step
sh """ 
docker image rm k8s-backup-azure-blob -f 
 """		// Shell build step
sh """ 
docker image rm hub.frank-loeppert.com/k8s-backup-azure-blob:2.2 -f 
 """ 
	}
}
}